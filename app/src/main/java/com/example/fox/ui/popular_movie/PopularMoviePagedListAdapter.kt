...
import com.example.fox.data.api.POSTER_BASE
...
import kotlinx.android.synthetic.main.notwork_state_item.view.*
...
class PopularMoviePagedListAdapter(public val context: Context) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == MOVIE_VIEW_TYPE) {
            ...
            view = layoutInflater.inflate(R.layout.notwork_state_item,parent,false)
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view){
        ...
        fun bind(movie: Movie?, context: Context){
            ...
            val moviePosterURL: String = POSTER_BASE + movie?.posterPath
    ...
    fun setNetworkState(newNetworkState: NetworkState){
        ...
        val handExtraRow:Boolean = hasExtraRow()
        this.networkState = newNetworkState
        val hasExtraRow: Boolean =hasExtraRow()

        if (handExtraRow!= hasExtraRow) {
            if (handExtraRow) {
